...
import 'package:flutter_application_1/Paginas/PreguntasVisual/visualfinal.dart';
import 'package:flutter_application_1/Paginas/score_manager.dart';

class QuestionScreenten extends StatelessWidget {
  final AudioPlayer _audioPlayer = AudioPlayer();

  QuestionScreenten({super.key});

  Future<void> playSound() async {
    // Reproduce el audio
    await _audioPlayer.play(AssetSource('audios/preg10.mp3'));
  }
    ...
    return GestureDetector(
      onTap: () {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => QuestionScreenfinal(),
          ),
        );
      },
      child: Column(
