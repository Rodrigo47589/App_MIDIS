...
import 'package:flutter_application_1/Paginas/PreguntasVisual/visualseven.dart';
import 'package:flutter_application_1/Paginas/score_manager.dart';

class QuestionScreensix extends StatelessWidget {
  final AudioPlayer _audioPlayer = AudioPlayer();

  QuestionScreensix({super.key});

  Future<void> playSound() async {
    // Reproduce el audio
    await _audioPlayer.play(AssetSource('audios/preg6.mp3'));
  }
    ...
    return GestureDetector(
      onTap: () {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => QuestionScreenseven(),
          ),
        );
      },
      child: Column(
